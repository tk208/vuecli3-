        ...
        <section>
          ...
          <div class="switch">
            <span 
              ...
              :class="{'selected': item.select}" class="switch-item item-line" :key="index" v-for="(item,index) in radioItem">
              {{item.name}}
            </span>
          </div>
          <div class="switch" :key="index" v-for="(item,index) in switchItem">
            <span :class="{'selected': item.select}" @click="item.select = !item.select" class="switch-item">
              {{item.name}}
            </span>
          </div>
        </section>
        <button @click="submitClick" class="btn-submit">
          确定 
        </button>
      </div>
    </div>
