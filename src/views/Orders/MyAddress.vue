          ...
          <div class="address-card" v-for="(address,index) in allAddress" :key="index">
            ...
            <div class="address-card-body" @click="setAddressInfo(address,index)">
              <p class="address-card-title">
                ...
                <span class="gender" v-if="address.sex">
                  {{address.sex}}
                </span>
                <span class="phone">
                  {{address.phone}}
              ...
              <p class="address-card-address">
                <span class="tag" v-if="address.tag">
                  {{address.tag}}
                </span>
...
export default {
    ...
    methods: {
        ...
        getData(){
          this.$axios(`/api/user/userInfo/${localStorage.ele_login}`)
            .then(res => {
        ...
        setAddressInfo(address,index){
          ...
          // 将address对象存储到vuex
          this.$store.dispath('setUserInfo',address)
